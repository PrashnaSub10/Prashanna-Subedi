...
function NavProfileCard({ profile, expanded }) {
    ...
    const namePronunciationAudioUrl = language.getTranslation(profile.locales, "audio", null) || language.getTranslation(profile.locales, "name_pronunciation_audio_url", null)
